        ...
        <div class="col-md-8 col-md-offset-2">
          <form role="form" class="form-horizontal" v-on:submit.prevent="sendApplication()" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" v-model="birthdate" style="background-color: #1c1d26;border: 1px solid #616167;" >
            </div>
            <div class="form-group">
              <label>Experience</label>
              <textarea class="form-control" placeholder="Experience" v-model="experience" style="border: 1px solid #616167;" ></textarea>
            </div>
            <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    sendApplication: function() {
      ...
      console.log(this.endTime.getTime() - this.startTime)
      this.loading = true
