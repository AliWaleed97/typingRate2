<template>
  <div class="projectProfileAdmin" align="center">
    <br>
    <br>
    <header class="major">
      <h2>{{project.name}}</h2>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>Engineer</td>
                <td>
                  <input type="text" v-model="project.engineer">
                </td>
              </tr>
              <tr>
                <td>Location</td>
              ...
              <tr>
                <td>Start Date</td>
                <td>
                  <input type="text" v-model="project.startDate">
                </td>
              </tr>
              <tr>
                <td>Completion Date</td>
                <td>
                  <input type="text" v-model="project.completionDate">
                </td>
              </tr>
            </tbody>
          </table>
          <a class="button special" style="margin-bottom: 10px;" v-on:click="editproject(project._id)">Update</a>
        </div>
      </section>
      <section id="content2">
        <div class="container">
...
export default {
  ...
  methods: {
    fetchProject: function() {
      this.$http.get(env.URL + '/user/getProject/'.concat(this.$route.params.project_id)).then(response => {
    ...
    editproject: function() {
      this.$http.post(env.URL + '/admin/updateProject', this.project, {
    ...
    addPic: function() {
      this.formData.append("Project_id", this.project._id)
