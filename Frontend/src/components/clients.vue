  ...
  <div class="clients">
    ...
    <section id="clients" class="section">
      ...
      <div class="container wow fadeInUp" data-wow-duration="700ms" data-wow-delay="600ms">
        ...
        <!--/row-->
        <div class="work-all wow fadeInUp" data-wow-duration="700ms" data-wow-delay="800ms">
          <router-link to="/clients"> <a class="btn btn-primary btn-lg" style="position: relative; z-index: 100;">View All Clients</a></router-link>
        </div>
      </div>
      <!--/container-->
    </section>
    ...
    fetchClients: function() {
      this.$http.get(env.URL + '/user/getAllClients').then((response) => {
        if (response.body.success) {
          this.clients = response.body.data.clients.slice(0,4)
